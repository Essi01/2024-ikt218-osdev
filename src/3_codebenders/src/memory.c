...
#include "stdio.h"
#include "util.h"
#include "memory.h" // Make sure to include this header only once

// Define the number of pages and directories
...
// Local static variables, not accessible outside this file
